...
@if(Auth::check() && Auth::user()->isAdmin())
	<a href="#" class="btn btn-default" data-toggle="modal" data-target="#section_form">Add Section</a>
@endif
...
@if(Auth::check() && Auth::user()->isAdmin())
<div class="modal fade" id="section_form" tabindex="-1" role="dialog" aria-hidden="true">
